...
```python
X, W_xh = ops.normal(mean=0, stddev=1, shape=(3, 1)), ops.normal(mean=0, stddev=1, shape=(1, 4))
H, W_hh = ops.normal(mean=0, stddev=1, shape=(3, 4)), ops.normal(mean=0, stddev=1, shape=(4, 4))
ops.matmul(X, W_xh) + ops.matmul(H, W_hh)
```
    ...
    [[ 3.02839684e+00,  3.72346902e+00,  6.52474546e+00,  4.53901577e+00],
     [-3.63139272e+00, -5.86261451e-01, -8.43538475e+00, -1.60999703e+00],
     [ 1.84415847e-01,  1.77999640e+00, -8.10330570e-01,  3.45945358e-02]])
...
```python
ops.matmul(ops.cat((X, H), 1), ops.cat((W_xh, W_hh), 0))
```
    ...
    Tensor(shape=[3, 4], dtype=Float32, value=
    [[ 3.02839684e+00,  3.72346902e+00,  6.52474594e+00,  4.53901577e+00],
     [-3.63139272e+00, -5.86261570e-01, -8.43538380e+00, -1.60999727e+00],
     [ 1.84415832e-01,  1.77999651e+00, -8.10330451e-01,  3.45945954e-02]])
